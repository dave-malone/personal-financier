...
<html>
	...
	<body>
		<a href="#create-income" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-income" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:incomeInstance, action:'save']" >
				<fieldset class="form">
